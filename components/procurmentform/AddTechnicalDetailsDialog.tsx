...
import AddTechnicalDetails from "./AddTechnicalDetails";
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      ...
      >
        <DialogHeader>
          ...
          {isSuccess && (
            <DialogDescription>Details added successfully</DialogDescription>
          )}
        </DialogHeader>
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center py-6">
            ...
            <Button onClick={handleClose} className="px-6 py-3">
