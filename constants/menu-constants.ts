  ...
  createMenuItem(
    ...
    [
      createMenuItem(
        "Register New Vendor",
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/vendors/registration`,
        MdPersonAdd,
        COLORS.green
      ),
      createMenuItem(
        ...
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/vendors/edit-agency`,
        FaChevronCircleRight,
        COLORS.orange
      ),
      createMenuItem(
  ...
  createMenuItem(
    ...
    [
      createMenuItem(
        "Create Tender",
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/procurement/add`,
        FaChevronCircleRight,
        COLORS.green
      ),
      createMenuItem(
      ...
      createMenuItem(
        ...
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/procurement/addtechnicaldetails`,
        FaChevronCircleRight,
        COLORS.purple
      ),
      createMenuItem(
      ...
      createMenuItem(
        "Bid Management",
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/procurement/addbidderdetails`,
        FaChevronCircleRight,
        COLORS.cyan
      ),
      createMenuItem(
        "Financial Details",
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/procurement/addfinanicaldetails`,
        FaChevronCircleRight,
        COLORS.green
      ),
      createMenuItem(
        "Contract Awards",
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/procurement/workorderdetails`,
        FaChevronCircleRight,
        COLORS.yellow
      ),
      createMenuItem(
        ...
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/procurement/cancel-tender`,
        FaChevronCircleRight,
        COLORS.red
      ),
      createMenuItem(
      ...
      createMenuItem(
        "Order Cancellations",
        ["ADMIN"],
        `${BASE_URLS.ADMIN}/procurement/cancel-work-order`,
        FaChevronCircleRight,
        COLORS.lime
      ),
    ]
