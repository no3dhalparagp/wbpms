...
export async function createWarishDetail(
  ...
  try {
    ...
    const newDetail = await prisma.warishDetail.create({
      data: {
        ...rawData,
...
export async function updateWarishDetail(
  ...
  try {
    ...
    const existingDetail = await prisma.warishDetail.findUnique({
      where: { id },
...
export async function deleteWarishDetail(
  ...
  try {
    ...
    const deletedDetail = await prisma.warishDetail.delete({
      where: { id },
    });
...
export async function reviewWarishCorrection(
  ...
  try {
    const request = await prisma.warishModificationRequest.findUnique({ where: { id: requestId } });
    ...
    const updatedRequest = await prisma.warishModificationRequest.update({
      where: { id: requestId },
      data: {
...
export async function getWarishCorrectionRequests(warishApplicationId: string) {
  return prisma.warishModificationRequest.findMany({
