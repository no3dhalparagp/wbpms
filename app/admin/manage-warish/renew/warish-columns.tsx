...
import { renewWarishApplication } from "@/app/actions/renew-warish-application";
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm">
                    Application renewal confirmation
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="mb-6">
                <p className="text-gray-700 mb-4">
                  Are you sure you want to renew this application? This action
                  will:
                </p>
