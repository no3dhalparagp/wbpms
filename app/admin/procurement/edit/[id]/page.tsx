...
import NitEditForm from "@/components/procurmentform/nit-edit-form";
...
export default async function EditNitPage({ params }: EditNitPageProps) {
  ...
  const initialData = {
    ...
    tender_pulishing_Date: nit.publishingDate
      ? new Date(nit.publishingDate)
      : new Date(),
    tender_document_Download_from: nit.documentDownloadFrom
      ? new Date(nit.documentDownloadFrom)
      : new Date(),
    tender_start_time_from: nit.startTime
      ? new Date(nit.startTime)
      : new Date(),
    ...
    tender_techinical_bid_opening_date: nit.technicalBidOpeningDate
      ? new Date(nit.technicalBidOpeningDate)
      : new Date(),
    tender_financial_bid_opening_date: nit.financialBidOpeningDate
      ? new Date(nit.financialBidOpeningDate)
      : undefined,
